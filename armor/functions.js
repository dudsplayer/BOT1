...
const banner = cfonts.render(('KITAGAWA'), {
    font: 'block',
    align: 'center',
...
const banner2 = cfonts.render(('By: - KITA - '), {
    font: 'chrome',
    align: 'center',
...
const banner3 = cfonts.render((`KITAGAWA`), {
font: 'block',
color: 'yellow',
align: 'center',
colors: 'red',
...
authorname = 'KITAGAWA'
packname = '[🎗️]STATUS[🎗️]\n[🎗️]24H ONLINE\n[🎗️]ULTRA SPEED\n[🎗️]CHAT: 55 73 99624212'
  
function addMetadata(packname, author) {	
if (!packname) packname = 'KITAGAWA-MD'; if (!author) author = 'ALE';	
